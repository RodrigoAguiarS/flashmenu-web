export const PERMISSOES = {
  ...
  ENTREGA_RECUSAR: 'entrega.recusar',
  ENTREGA_INICIAR: 'entrega.iniciar',
  ENTREGA_CONCLUIR: 'entrega.concluir',
...
export const ADMIN_NAV_ITEMS: readonly NavItem[] = [
  ...
  { id: 'entregas', label: 'Entregas', route: '/entregas', icon: 'car', exact: true, permissoes: PERMISSOES_ROTAS.ENTREGAS },
